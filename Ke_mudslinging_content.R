...
custom_stopwords <- c("關係", "回應","在野", "其實", "後來", "候選人", "導致", "臺灣", "知道", "第二", "記得", "只能", "越來越", "認同","行政院", "這是", "超過", "高喊", "立法", "wen", "ing", "tsai","擔任", "時期", "不會","曾經", "蔡英文", "繁榮", "面對", "是否", "不要", "一場", "13", "發展", "要求", "政黨", "感謝", "看到", "我要", "完成", "個人", "機會", "包括", "政黨輪替", "表達", "請問", "藍白", "藍白", "柯文哲", "民眾黨","參選人", "參選","無法", "目標", "力量","不斷", "完全", "實現", "希望", '政策', '立委', '改變', '支持', '告訴', '願意', '推動', '承諾', '這片', '再次', '最大', '中央', '重要', '到底', '建設','期待', 
